...
function displayUI(response){
   ...
   //bike2_distance=Number(response.bike2_distance);
                 ...
                 VIDEO_PLAY_TO_2=bike2_distance*vidlength/1000;
                 pause_time2=Number(VIDEO_PLAY_TO_2);
...
interval=0;
diff2=Number(bike2_distance-running_distance2);
if (diff2==0 ) 
{
    myPlayer2.pause()  
   initiated2="not";
    ...
    //clearInterval(interval);
    console.warn("delay ended")
    running_distance2=bike2_distance;
    if (initiated2=="initiated")
     {
        // console.warn(bike1_distance+" --ALREADY DONE "+running_distance)    
     }
     else{
         myPlayer2.play();
         initiated2="initiated";
       // console.warn(bike1_distance+" --JUST INITIATED "+running_distance)
        // initiated="initiated";
     }
