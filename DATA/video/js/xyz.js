var _0x8b91 = ['#start_hunt', '&points=', 'PID', '</div><div\x20class=\x22choices\x22>', '531708neGYmh', 'inactive', '</button>', 'removeClass', 'playing', 'scripts/update_points.php', 'POST', 'error', ':checked', '#inst_start', 'accuracy=', 'setInterval', '0:11', '86WNYgvf', '#time', 'indexOf', 'Please\x20Choose\x20Your\x20Team', '35575kwJZOg', 'info', '<div\x20class=\x22top_div\x22><div\x20class=\x22question\x22>', 'timeupdate', 'ajax', 'Uploading\x20your\x20results...', 'log', '#progress_holder', 'text', 'contextmenu', 'ready', 'response', '#vt', 'accuracy', '&player=', 'preventDefault', 'scripts/update_rt.php', 'wrong', 'val', 'VID', 'setItem', '\x20animated', 'current_choice_selected', 'activate', 'correct', '.game_content', 'nopoints', '.submit_bt', 'click', 'html', 'fadeIn', 'getItem', '#green_progress', 'value', 'addEventListener', 'split', 'aid', 'check', 'up_results', 'sec', 'append', '%;\x22><button\x20id=\x22indicator_', '14RAkhAr', 'webkitAnimationEnd\x20mozAnimationEnd\x20MSAnimationEnd\x20oanimationend\x20animationend', '#terms', 'getElementById', '#question_holder', 'json', '0:40', 'q_type', 'hidden', 'Please\x20make\x20atleast\x201\x20choice', '&team=', '\x22\x20\x20\x20>Submit\x20Answer</button></div>', 'body', 'length', 'yes', '#final_time', 'charAt', 'done', 'Engagement\x20has\x20been\x20closed', '<div\x20class=\x22group_indicator\x20\x22\x20style=\x22left:\x20', '5000', 'is_selected', 'toLowerCase', 'Time\x27s\x20Up\x20Sorry,\x20But\x20you\x20have\x20run\x20out\x20of\x20time\x20', 'toString', '&aid=', 'Checking...', '.content_end', '.home', '&time_taken=', 'uncheck', 'localStorage', 'Logging\x20in...', 'yellow', 'status', '&ek_number=', '\x22\x20class=\x22circle_number\x20', '#my-video', '</button><div\x20class=\x22time_display\x22>', '356618xmhiiB', '</div></div>', 'player=', 'play', '#score', '31399pfhCUo', 'data', 'c_count', 'paused', '7442bhmSSz', 'volume', 'Your\x20Name\x20is\x20required', '648300uyvgUQ', 'Please\x20Enter\x20your\x20Name', '&quiz=22', '#txt_err', '0:50', 'pause', '.answer_holder', '0:25', 'answer_text', 'controls', 'data_upload', 'one', 'fadeOut', '.game_terms', '#indicator_', 'scripts/login.php', '#terms_back', '#modal_', '#final_score', '&UA=', 'push', '&DID=', 'addClass', '--SPLICED\x20SINGLE', 'currentTime', '208140AyKoHw'];
...
$(_0x1ab9ab(0xc1))['on'](_0x1ab9ab(0xa7), _0x1ab9ab(0x123), function() {
  ...
  if ($(_0x35f225(0xb7))['is'](_0x35f225(0x10e))) {
    if (fname == '') swal({
      ...
      if (ek_number == '') swal({
        'title': 'Please\x20Enter\x20Staff\x20ID',
        'text': '',
        'icon': _0x35f225(0x10d)
      });
      else team == '' ? swal({
        ...
        'success': function(_0x959da2) {
          ...
          if (response == '2') PLAYER_ID = _0x959da2['id'], time_taken = _0x959da2['time_taken'], accuracy = _0x959da2[_0x30ceaa(0x124)], clientStorage['setItem'](_0x30ceaa(0x104), PLAYER_ID), takeMeTo(_0x30ceaa(0xd1), _0x30ceaa(0xd0)), $(_0x30ceaa(0xfa))['text'](accuracy + '%'), $(_0x30ceaa(0xc4))[_0x30ceaa(0xa8)](time_taken + _0x30ceaa(0xb2)), console['log'](response);
            ...
            if (response == 0x3) swal({
              'title': 'Please\x20Try\x20again\x20later',
              'text': '',
              'icon': 'error'
            });
            else response == 0x4 && swal({
              'title': 'Engagement\x20Closed',
              'text': _0x30ceaa(0xc7),
              'icon': 'error'
            });
          }
    ...
    'title': 'Please\x20Accept\x20Terms\x20and\x20Conditions',
    'text': '',
    'icon': 'error'
  });
...
function takeMeTo(_0x8ae478, _0x352a38) {
  var _0x36d11b = _0x1ab9ab,
    _0x2c4fee = $(_0x8ae478);
  out_anime = _0x36d11b(0xf4), _0x2c4fee[_0x36d11b(0x109)](out_anime + '\x20animated')[_0x36d11b(0xfe)](out_anime + _0x36d11b(0xa0))[_0x36d11b(0xf3)](_0x36d11b(0xb6), function() {
  ...
  for (var _0x3f3f41 = 0x0; _0x3f3f41 < total_items; _0x3f3f41++) {
    ...
    if (_0x306fad == c_count) {
      ...
      for (var _0x2ee374 = 0x0; _0x2ee374 < answer_length; _0x2ee374++) {
        html_code = html_code + '<button\x20\x20class=\x22ans\x20answer_holder\x22\x20\x20data-is_selected=\x22no\x22\x20data-pos=\x221\x22\x20\x20\x20data-q=\x22' + questions['id'] + '\x22\x20data-a=\x22' + answers[_0x2ee374][_0x205e6d(0xaf)] + '\x22\x20data-qm=\x22' + answers[_0x2ee374][_0x205e6d(0xd7)] + '\x22>' + answers[_0x2ee374][_0x205e6d(0xf0)] + _0x205e6d(0x108);
      }
      html_code = html_code + '</div></div><div\x20class=\x22bottom_div\x22><button\x20id=\x22submit_answer\x22\x20class=\x22butty\x20submit_bt\x22\x20data-id=\x22' + questions['id'] + _0x205e6d(0xc0);
    }
  }
